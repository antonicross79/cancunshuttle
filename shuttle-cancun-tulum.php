...
<html lang="en">
   ...
   <!---Este es el link de conexion de pinterest-->
	...
	<title>Shuttle Cancun Tulum - CancunShuttleAirport.com</title>
    <meta name="description" content="Hotel Airport Cancun.Transfer Cancun Aeropuerto and Playa del Carmen Transfer,Tulum and Riviera Maya.We have taxi airport cancun and Shuttle Cancun.Realizamos traslados de Aeropuerto Cancun, Zona hotelera,Riviera Maya, Tulum y más."/>
  ...
  <body>
	...
	<main class="container-fluid">
		...
		<header class="site-title color" >
			<div class="wrap">
				<div class="container">
					<h1 class= "text-center">Shuttle Cancun Tulum</h1>
...
<!-- //Intro -->
		...
		<div class="form-row p-5" style="border: 1px solid #00000059;border-radius: 20px;box-shadow: 5px 5px 10px 2px #00000042;background: white;">
		 ...
		 <div class="container-fluid">
			...
			<div class="container-fluid col-10 mt-4"> <h2 class="text-center mt-5" > Shuttle Cancun Tulum</h2>
