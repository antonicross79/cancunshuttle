...
<html>
  <head>
	...
	<title>Cancun Transfer | CancunShuttleAirport</title>
    <meta name="description" content=" We have more than 20 years of Cancun Transfer service providing transportation services from Cancun Airport to any hotel or place in Cancun, Riviera Maya and Tulum.">
  ...
  <body>
	...
	<main class="main" role="main">
		...
		<header class="site-title color">
			<div class="wrap">
				<div class="container">
					<h1>Cancun Transfer</h1>
					<nav role="navigation" class="breadcrumbs">
						<ul>
							<li><a href="index.php" title="Home">Home</a></li>
							<li>Cancun Transfer</li>
						</ul>
					</nav>
				</div>
			</div>
		...
		<div class="wrap">
			<div class="row">
				...
				<div class="content three-fourth textongrey">
				    <!-- <h2>About us</h2> --><br>
				    		<img src="../images/taxi_aeropuerto_cancun.jpg" alt="Cancun Transfer" width="850" heigth="700"> <p><br></p>
				    				    
					<h1>Cancun Transfer <span>Service 24/7</span></h1><br>
					<p class="lead">We have more than 20 years of Cancun Transfer service providing transportation services from Cancun Airport to any hotel or place in Tulum, Cancun and Riviera Maya</p>.
                                     <a href="index.php">BOOK NOW </a>
                                     
                                     <a href="https://api.whatsapp.com/send?phone=+529983545838" target="_blank" ><img src="images/whats2.png" alt="Cancun Transfer" width="250" hight="100"/></a> 
