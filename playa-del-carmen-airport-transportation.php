...
<html lang="en">
   ...
   <!---Este es el link de conexion de pinterest-->
	...
	<title>Playa del Carmen Airport Transportation - CancunShuttleAirport.com</title>
    <meta name="description" content="Playa del Carmen Transportation.Transfer Cancun Aeropuerto and Playa del Carmen Transfer,Tulum and Riviera Maya.We have taxi airport cancun and Shuttle Cancun.Realizamos traslados de Aeropuerto Cancun, Zona hotelera,Riviera Maya, Tulum y más."/>
  ...
  <body>
	...
	<main class="container-fluid">
		...
		<header class="site-title color" >
			<div class="wrap">
				<div class="container">
					<h1 class= "text-center">Playa del Carmen Airport Transportations</h1>
...
<!-- //Intro -->
	    ...
	    <!-- carrusel principal -->
		 ...
		 <div class="container-fluid">
				  ...
				  <div class= "col-md-8 col-md-offset-3 mb-3 rounded"> 
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="images/playa-del-carmen.jpeg" class="d-block w-100" alt="playa del carmen">
                        </div>
			...
			<div class="container-fluid col-10 mt-4"> <h2 class="text-center mt-5" > Playa del Carmen Airport Transportation</h2> 
						        		             <p class="mt-3">Playa del Carmen Airport Transportation. It is a beautiful coastal city that is located 55 km from Cancun Airport, if you do not have transportation you can contact us we are Cancun Shuttle Airport we have transfers from Airport-Hotel, or <a href="https://cancunshuttleairport.com/shuttle-cancun-tulum.php">Hotel-Tulum</a>, Hotel-Holbox, or some other destination you would like to visit.
                            ...
                            <p>In cancun shuttle we have transfers throughout cancun, mayan riviera, tulum, <a href="https://cancunshuttleairport.com/isla-mujeres-airport-transportation.php">isla mujeres </a>and more. You can contact us for more information</p>
			 ...
			 <div class ="row mb-5" >
				 <div class="col-12 col-sm-6 col-md-3 mx-auto d-block mt-3"> 
					<div class="card" style="width: 22rem;">
					  <img class="card-img-top" src="images/camioneta1.jpeg"  alt="playa del carmen transportation">
					  <div class="card-body">
					...
					<div class="col-12 col-sm-6 col-md-3 mx-auto d-block mt-3">
					<div class="card" style="width: 22rem;">
					  <img class="card-img-top" src="images/camioneta3.jpeg" alt="playa del carmen transportation">
					  <div class="card-body">
					...
					<div class="col-12 col-sm-6 col-md-3 mx-auto d-block mt-3">
					 <div class="card" style="width: 22rem;">
					  <img class="card-img-top" src="images/camioneta2.jpeg" alt="playa del carmen transportation">
					  <div class="card-body">
