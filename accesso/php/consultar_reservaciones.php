    ...
    while($row = mysqli_fetch_array($respuesta))
    {
        ...
        $output .= '<tr style="text-align: center;">
                        ...
                        if ($row['tipo_pago'] == 'DIRECTO') {
                            ...
                            $output .= '<td><img src="../dist/img/credit/stripe.png" alt="Stripe" width="51" height="32"></td>';
                        }
    ...
    echo '<div class="modal-header">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    <i class="fas fa-globe"></i> CancunShuttleAirport, Inc.';
                       ...
                       Echo '<div class="row">
                                ...
                                <div class="col-6">
                                 Aerolinea y Hora de llegada
                                  ...
                                  <p class="lead">Hotel Pickup Time:</p>
                                  <address>
                                  <strong>'.$pickup_hour.':'.$pickup_minute.' '.$pmam.'</strong><br>
                                  </address>
                      ...
                      Echo '<div class="row">
                                ...
                                <div class="col-6">
                                 Aerolinea y Hora de llegada
                                  ...
                                  <img src="../dist/img/credit/stripe.png" alt="Stripe" width="51" height="32">

                                  <p class="text-muted well well-sm shadow-none" style="margin-top: 10px;">
                                    ID TRANSACCION:
                                  <address>
                                  <strong>'.$row['transaccion_stripe'].'</strong><br>
                                  </address>
                                  </p>
    ...
    while($row = mysqli_fetch_array($respuesta))
    {
        ...
        $output .= '<tr style="text-align: center;">
                        ...
                        if ($row['tipo_pago'] == 'DIRECTO') {
                             ...
                             $output .= '<td><img src="../dist/img/credit/stripe.png" width="50px" height="35px" alt="Stripe"></td>';
                        }
