...
<html>
  <head>
    ...
    <meta name="description" content=" We have more than 20 years of Taxi airport Cancun service providing transportation services from Cancun Airport to any hotel or place in Cancun, Riviera Maya and Tulum.">
  ...
  <body>
	...
	<main class="main" role="main">
		...
		<header class="site-title color">
			<div class="wrap">
				<div class="container">
					<h1>Taxi airport Cancun</h1>
					<nav role="navigation" class="breadcrumbs">
						<ul>
							<li><a href="index.php" title="Home">Home</a></li>
							<li>Taxi airport Cancun</li>
						</ul>
					</nav>
				</div>
			</div>
		...
		<div class="wrap">
			<div class="row">
				...
				<div class="content three-fourth textongrey">
				    <!-- <h2>About us</h2> --><br>
				    		<img src="../images/taxi_aeropuerto_cancun.jpg" alt="Taxi airport Cancun" width="850" heigth="700"> <p><br></p>
				    				    
					<h1>Taxi airport Cancun <span>Service 24/7</span></h1><br>
					<p class="lead">We have more than 20 years of Taxi airport Cancun service providing transportation services from Cancun Airport to any hotel or place in Cancun, Riviera Maya and Tulum</p>.
                                     <a href="index.php">BOOK NOW </a>
                                     
                                     <a href="https://api.whatsapp.com/send?phone=+529983545838" target="_blank" ><img src="images/whats2.png" alt="Taxi airport Cancun" width="250" hight="100"/></a> 
