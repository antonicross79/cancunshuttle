...
<html lang="en">
   ...
   <!---Este es el link de conexion de pinterest-->
	...
	<title>Cancun Shuttle - CancunShuttleAirport.com</title>
    <meta name="description" content="Cancun Shuttle.Transfer Cancun Aeropuerto and Playa del Carmen Transfer,Tulum and Riviera Maya.We have taxi airport cancun and Shuttle Cancun.Realizamos traslados de Aeropuerto Cancun, Zona hotelera,Riviera Maya, Tulum y más."/>
  ...
  <body>
	...
	<main class="container-fluid">
		...
		<header class="site-title color" >
			<div class="wrap">
				<div class="container">
					<h1 class= "text-center">Cancun Shuttle</h1>
