...
<!-- Header -->
 ...
 Name and Surname</label>
  ...
  <path d="M16 11l2 2l4 -4" /></svg></div>
				    ...
				    <input type="text" name="n_persona" class="form-control" id="n_persona" aria-describedby="emailHelp" placeholder="Enter your name and surname" required="">
				  </div>
				  <div class="input-group col-xs-12 col-md-6">
				  	<label for="t_persona"  class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2"> Mobile Number</label>
				  	<div class="input-group-prepend">
		  		 ...
		  		 <div class="form-row">
			  		 <div class="input-group col-xs-12 col-md-6">
					    <label for="e_persona" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Email Address</label>
					    <div class="input-group-prepend">
						  <div class="input-group-text">
					  ...
					  <div class="input-group col-xs-12 col-md-6">
					    <label for="e_persona2" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Confirm Email</label>
					    <div class="input-group-prepend">
						  <div class="input-group-text">
						  	<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00abfb" fill="none" stroke-linecap="round" stroke-linejoin="round">
							  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
				 ...
				 <div class="form-row">
				 	<div class="input-group mb-3 col-xs-12 col-md-6">
						<label for="country" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Country</label>
					  <div class="input-group-prepend">
					...
					<div class="input-group mb-3 col-xs-12 col-md-6">
						<label for="city" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">City</label>
					  <div class="input-group-prepend">
				 ...
				 <div class="form-row">
				 	<div class="input-group mb-3 col-xs-12 col-md-6">
						<label for="flying_from" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Flying From</label>
					  <div class="input-group-prepend">
					    <label class="input-group-text" for="inputGroupSelect01"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-map" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00abfb" fill="none" stroke-linecap="round" stroke-linejoin="round">
						  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
						  <polyline points="3 7 9 4 15 7 21 4 21 17 15 20 9 17 3 20 3 7" />
					  ...
					  <div class="input-group col-xs-12 col-md-6">
					    <label for="Airline" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Airline</label>
					    <div class="input-group-prepend">
						  <div class="input-group-text">
					  ...
					  <div class="input-group col-xs-12 col-md-6">
					    <label for="flight_number" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Flight Number</label>
					    <div class="input-group-prepend">
						  <div class="input-group-text">
					...
					<div class="input-group mb-3 col-xs-3 col-md-3">
							<label for="pickup_minute" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Minutes</label>
						  <div class="input-group-prepend">
						    <label class="input-group-text" for="inputGroupSelect01"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clock" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00abfb" fill="none" stroke-linecap="round" stroke-linejoin="round">
							  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
							  <circle cx="12" cy="12" r="9" />
							...
							<div>
								...
								<table class="table table-sm">
									<tbody>
										...
										<tr>
											<td scope="row">Amount of people</td>
