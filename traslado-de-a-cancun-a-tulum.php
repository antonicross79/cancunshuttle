...
<html lang="en">
   ...
   <!---Este es el link de conexion de pinterest-->
	...
	<title>Traslado de Cancun a Tulum - CancunShuttleAirport.com</title>
    <meta name="description" content="Traslado de cancun a Tulum.Transfer Cancun Aeropuerto and Playa del Carmen Transfer,Tulum and Riviera Maya.We have taxi airport cancun and Shuttle Cancun.Realizamos traslados de Aeropuerto Cancun, Zona hotelera,Riviera Maya, Tulum y más."/>
  ...
  <body>
	...
	<main class="container-fluid">
		...
		<header class="site-title color" >
			<div class="wrap">
				<div class="container">
					<h1 class= "text-center">Traslado de Cancun a Tulum</h1>
...
<!-- //Intro -->
		...
		<div class="form-row p-5" style="border: 1px solid #00000059;border-radius: 20px;box-shadow: 5px 5px 10px 2px #00000042;background: white;">
		 ...
		 <div class="container-fluid">
				  ...
				  <div class= "col-md-8 col-md-offset-3 mb-3 rounded"> 
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="images/tulumm.jpeg" class="d-block w-100" alt="hotel airport cancun">
                        </div>
			...
			<div class="container-fluid col-10 mt-4"> <h2 class="text-center mt-5" > Traslado de Cancun a Tulum</h2>
						        		             <p class="mt-3">It is a city on the coast of the Riviera Maya an hour and a half from Cancun Airport, if you do not have transportation for your next vacation you can contact us we are Cancun Shuttle Airport we have transfers from <a href="https://cancunshuttleairport.com/cancun-airport-transportation.php">Airport-Hotel</a> to the city of Tulum or Hotel-Akumall or some other place that you would like to know.</p>

                            </p>In Tulum you can find beautiful beaches and an attraction that you cannot miss are the Mayan ruins of Tulum that are on the seashore of the cove of Tankah, they also find beautiful cenotes.</p>
			 ...
			 <div class ="row mb-5" >
				 <div class="col-12 col-sm-6 col-md-3 mx-auto d-block mt-3"> 
					<div class="card" style="width: 22rem;">
					  <img class="card-img-top" src="images/camioneta1.jpeg"  alt="shuttle cancun tulum">
					  <div class="card-body">
					...
					<div class="col-12 col-sm-6 col-md-3 mx-auto d-block mt-3">
					<div class="card" style="width: 22rem;">
					  <img class="card-img-top" src="images/camioneta3.jpeg" alt="shuttle cancun tulum">
					  <div class="card-body">
					...
					<div class="col-12 col-sm-6 col-md-3 mx-auto d-block mt-3">
					 <div class="card" style="width: 22rem;">
					  <img class="card-img-top" src="images/camioneta2.jpeg" alt="shuttle cancun tulum">
					  <div class="card-body">
