...
if ($fecha_r != '') {
	$sql = "INSERT INTO reservaciones (ubicacion_desde, ubicacion_hasta , transporte, id_t_traslado, nombre_p, telefono_p, email_p, direccion_p, codigo_p, ciudad_p, pais_p, tipo_pago, cantidad_personas, total, fecha_ida, fecha_regreso,aerolinea,modo_viaje,lang,comments,pickup_hour,pickup_minute) VALUES ('".$destino_1."','".$destino_2."','".$nombre_transporte."',".$tipo_traslado2.",'".$nombre_persona."','".$telefono_persona."', '".$email_persona."', '".$direccion_persona."', '".$codigo_postal."', '".$ciudad."', '".$pais."','".$tipo_de_pago."','".$personas."',".$precio_total.", '".$fecha."','".$fecha_r."','".$airline."','".$tipo_traslado."','en','".$comments."','".$pickup_hour."','".$pickup_minute."');";
}else{
	$sql = "INSERT INTO reservaciones (ubicacion_desde, ubicacion_hasta , transporte, id_t_traslado, nombre_p, telefono_p, email_p, direccion_p, codigo_p, ciudad_p, pais_p, tipo_pago, cantidad_personas, total, fecha_ida, aerolinea,modo_viaje,lang, comments,pickup_hour,pickup_minute) VALUES ('".$destino_1."','".$destino_2."','".$nombre_transporte."',".$tipo_traslado2.",'".$nombre_persona."','".$telefono_persona."', '".$email_persona."', '".$direccion_persona."', '".$codigo_postal."', '".$ciudad."', '".$pais."','".$tipo_de_pago."','".$personas."',".$precio_total.", '".$fecha."','".$airline."','".$tipo_traslado."','en','".$comments."','".$pickup_hour."','".$pickup_minute."');";
}
...
if ($tipo_de_pago == 'PAYPAL' ) {
  ...
  //$paypal_url = 'https://www.paypal.com/cgi-bin/webscr';
	...
	$cancel_return = "https://cancunshuttleairport.com/booking-step2.php";
	//Colocal la URL donde se redicciona cuando el pago fue completado con exito.
	$success_return = "https://cancunshuttleairport.com/booking-step3.php";
		...
		<main class="main" role="main">
			...
			?>
					...
					<div class="col-xs-12 col-md-9 text-center">
						<h5>Click on the button to pay with Stripe</h5>
						...
						<img src="/images/pago-seguro-stripe.png" alt="transfers private cancun" width="300" heigth="200">
...
elseif ($tipo_de_pago == 'DIRECTO') {
	...
	$contenido_correo.= '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
      ...
      $contenido_correo.='<img src="https://cancunshuttleairport.com/images/logocancuntransportation.jpg" width="150" height="60" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
		...
		<div class="">
		<span>Your confirmation code ixs: <b>CT0000000'.$row['MAX(id_reservacion)'].'</b></span>
		<span style="float: right;">TOTAL: <b>'.($rowSumaTotal['suma']+$precio_total).',00 USD</b></span>
		</div>
		<table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
		  <tbody>
		    <tr>
		...
		<table class="table" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 100%;">
		  <thead>
		    <tr>
		      ...
		      <th width="50%" style="line-height: 24px;  border-bottom-width: 2px; border-bottom-color: #dee2e6; border-bottom-style: solid; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0;" align="left" valign="top">FLIGHT NUMBER</th>
		    </tr>
		  </thead>
		  <tbody>
		    <tr>
		...
		<table class="table" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 100%;">
		  ...
		  <tbody>';
			...
			$contenido_correo.= '<tr>	
	                                    ...
	                                    <td></td>
	                                    <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px;  border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0;" align="left" valign="top">'.$suma_precio.',00 USD</td>
	                                  </tr>';   
		...
		<table class="alert alert-success " border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; width: 100%; border: 0;">
		  ...
		  PAID IN CASH<br>
		  <b>Please REMEMBER to pay in cash with USD <br>at you Arrival to our Driver</b>
		</div>
		      </td>
		    </tr>
		  </tbody>
...
<thead>
  <tr>
     <th><img src="https://cancunshuttleairport.com/images/operator.jpeg" alt="transfers private cancun"  width="150" height="200"></th>
...
';
		...
		mail("pauescamilla05@gmail.com",utf8_decode("CancunShuttleAirport Ticket Reservation"),$contenido_correo,$header);
		mail("cantranportation18@gmail.com",utf8_decode("CancunShuttleAirport Ticket Reservation"),$contenido_correo,$header); 
		
		mail("ditaguirre@gmail.com",utf8_decode("CancunShuttleAirport Ticket Reservation"),$contenido_correo,$header);  
			...
			<div class="row">
				<div class="three-fourth">
					...
					<form class="box readonly">
						...
						<a href="https://cancunshuttleairport.com">Go to HomePage</a>
					</form> </center>
					</div>
				</div>
