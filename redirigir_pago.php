...
//	$contenido_correo.= "<img src='https://cancunshuttleairport.com/images/welcome.jpg' style='width:100%;'><br>";
    ...
    $contenido_correo.= "<img src='https://cancunshuttleairport.com/images/personalinformation.jpg' style='width:100%;'>";
...
//	$contenido_correo.= "Zip code: ".$codigo_postal."<br><br>";
    ...
    $contenido_correo.= "<img src='https://cancunshuttleairport.com/images/transfer.jpg' style='width:50%;'><br>";
	...
	if ($tipo_traslado == 1) {
		$contenido_correo.= "<img src='https://cancunshuttleairport.com/images/return.jpg' style='width:50%;'><br>";
	...
	$contenido_correo.= "<p>Total:  ".$precio_total.",00 USD</p><br>";
	 ...
	 $contenido_correo.= "<img src='https://cancunshuttleairport.com/images/payment.jpg' style='width:105%;'>";
	 $contenido_correo.= "<img src='https://cancunshuttleairport.com/images/step.jpg' style='width:105%;'>";
	 $contenido_correo.= "<img src='https://cancunshuttleairport.com/images/policies.jpg' style='width:105%;'>";
	 $contenido_correo.= "<img src='https://cancunshuttleairport.com/images/information.jpg' style='width:105%;'>";
	  $contenido_correo.= "<img src='https://cancunshuttleairport.com/images/arrive.jpg' style='width:105%;'>";
