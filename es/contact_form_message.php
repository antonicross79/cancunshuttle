...
$address = "info@cancunshuttleairport.com";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<h6>Correo enviado con exito.</h6>";
	echo "<p>Gracias $name, su mensaje nos ha sido enviado, le responderemos a la brevedad </p>";
	echo "</div>";
	echo "</fieldset>";
} 
else {
