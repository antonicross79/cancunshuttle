...
';
        ...
        <table valign="top" class="bg-light body" style="outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; color: #000000; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin: 0; padding: 0; border: 0;" bgcolor="#f8f9fa">
          ...
          <tbody>
           ...
           <div style="background-color: #33a5ff;">';
      $contenido_correo.='<img src="https://Cancunshuttleairport.com/es/images/logocancuntransportation.jpg" width="130" height="30" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
...
<thead>
  <tr>
     <th><img src="https://cancunshuttleairport.com/es/images/operator.jpeg" alt="transfers private cancun"  width="150" height="200"></th>
			...
			<div class="row">
				<div class="three-fourth">
					...
					<center><h1>GRACIAS POR RESERVAR!</h1><br>
						...
						<div align="center">
                                 <a href="https://taxiaeropuertodecancun.com/es/index.php">Ir a Pagina Pincipal</a>
                        </form> </center>
					</div>
				</div>
