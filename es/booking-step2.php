		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-xs-12 col-md-9">
						<h2>PAY CASH</h2>
						<p><h4>Porfavor seleccione un metodo de pago para hacer su reservación.</h4></p>
						
						<img src="/images/pago-seguro.png" alt="transfers private cancun" width="350" heigth="250"> <p><br></p>
						
						<div>
						<form action="redirigir_pago_new_format.php" method="POST">
							<div class="form-check">
							  <input class="form-check-input" style="width: 10px;height: 10px;" type="radio" name="t_pago" id="t_pago1" value="DIRECTO" checked>
							  <label class="form-check-label" for="t_pago1">
							    Pago Directo. Pague al abordar
							  </label>
								</div>
								<div class="form-check">
								  <input class="form-check-input" style="width: 10px;height: 10px;" type="radio" name="t_pago" id="t_pago2" value="PAYPAL">
								  <label class="form-check-label" for="t_pago2">
								    Pago seguro con Paypal
								  </label>
								  <br>
								  <span id="spanPaypal" style="display: none; position: absolute; top: 17px; color:red; font-size: 13px; font-weight: 600;" >se cobrara el 9% de comision</span>
								</div>
								<div class="form-check">
								  ...
								  <br>
								  <span id="spanStripe" style="display: none; position: absolute; top: 17px; color:red; font-size: 13px; font-weight: 600;" >se cobrara el 9% de comision</span>
								</div>
						<?php 
						...
						?>
						<button type="submit" class="btn medium color mt-3" >Continuar</button>
					</form>
				</div>
			</div>
