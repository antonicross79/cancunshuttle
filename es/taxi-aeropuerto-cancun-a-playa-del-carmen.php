  ...
  <body>
	...
	<main class="container-fluid">
		...
		<header class="site-title color" >
			<div class="wrap">
				<div class="container">
					<h1 class= "text-center">Taxi Aeropuerto Cancun a Playa del Carmen</h1>
...
<!-- //Intro -->
		...
		<div class="form-row p-5" style="border: 1px solid #00000059;border-radius: 20px;box-shadow: 5px 5px 10px 2px #00000042;background: white;">
		 ...
		 <div class="container-fluid">
				  ...
				  <div class= "col-md-8 col-md-offset-3 mb-3 rounded"> 
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="../images/playa-del-carmen.jpeg" class="d-block w-100" alt="Taxi Aeropuerto Cancun a Playa del Carmen">
                        </div>
			...
			<div> <h2 class="text-center mt-5"> Taxi Aeropuerto Cancun a Playa del Carmen </h2> </div>
						        		             <p class="mt-3"><p>Transportación al Aeropuerto de Playa del Carmen. Es una hermosa ciudad costera que se encuentra a 55 km del aeropuerto de Cancún, si no cuenta con transporte puede contactarnos somos Cancún Shuttle Airport tenemos traslados desde aeropuerto-hotel, o <a href = "https://cancunshuttleairport.com/es/taxi-aeropuerto-cancun-a-tulum.php"> Hotel-Tulum </a>, Hotel-Holbox, o algún otro destino que le gustaría visitar.</p>
                             <p> En Playa del Carmen puedes encontrar cenotes de agua, los cuales son hermosos por sus formaciones de agua cristalina y estalactitas, además si te gusta ir de compras y comer en los mejores restaurantes está la Quinta Avenida, que es una avenida que recorre todo el paralelo de la ciudad con tiendas, restaurantes y discotecas.</p>
                             <p>En cancun shuttle tenemos traslados a lo largo de cancun, mayan riviera, tulum, <a href="https://cancunshuttleairport.com/es/taxi-aeropuerto-cancun-a-isla-mujeres.php"> isla mujeres </a> y más. Puede contactarnos para más información.</p>
