			...
			<div class="input-group mb-3 col-xs-12 col-md-3" id="number_passengers">
			  ...
			  <select class="form-control col-xs-12 col-md-6 mr-2" name="people" id="inputGroupSelect01" style="height:auto;">
			  	...
			  	for ($i=1; $i < 17; $i++) { 
			  		if($i == $personas){
			  			?>
			  			<option value="<?php echo $i; ?>" selected><?php echo $i; ?>  Pasajero<?php echo $i!=0?'s':''; ?></option>
			  			<?php	
			  		}else{
			  			?>
						<option value="<?php echo $i; ?>"><?php echo $i; ?>  Pasajero<?php echo $i!=0?'s':''; ?></option>
				  		<?php	
			  		}
			...
			<div class="row">
				...
				<div class="full-width content">
						...
						if ($tipo_traslado == 4 || $tipo_traslado == 2 || $tipo_traslado == 3 ) {
								...
								echo '<h2>Eliga su Vehiculo para Traslado de Salida</h2>';
								...
								<form action="extras.php" method="POST">
									...
									<div class="one-half heightfix">
										...
										<ul>
											<li>
												...
												<p>Max <strong>'.$transportes['cantidad_max'].'</strong> <br />por vehiculo</p>
											</li>
											<li>
											...
											<li>
												...
												<p>Tiempo estimado <br /><strong>50 mins</strong></p>
											</li>
										</ul>
									</div>
									<div class="one-fourth heightfix">
										<div>
											<div class="price">'.$aux_precio.',00 <small>USD</small></div>
											<span class="meta">por vehiculo</span>
											<button type="submit" class="btn btn-primary large">seleccionar</button>
										</div>
									</div>
									...
									<div class="full-width information" id="'.$transportes['id_transporte'].'" style="">	
										<a href="javascript:void(0)" class="close color" title="Close">x</a>
											<p>Incluye: viaje privado, agua, wifi, 1 silla de bebé, cargador usb apple y android, aire acondicionado, seguro de viaje.</p>
									</div>
					...
					?>
						...
						<?php
						if ($tipo_traslado == 1) {	
						    echo '<h2>Eliga su Vehiculo para Traslado de Redondo</h2>';
							while ($transportes2 = mysqli_fetch_array($respuesta3)) {
								...
								<form action="extras.php" method="POST">
									<div class="one-fourth heightfix"><img src="'.$ruta_imagen.'" alt="" style="padding-top:40px;" /></div>
									<div class="one-half heightfix">
										<h3>'.$transportes2['n_transporte'].'<a onclick="showInfo('.$transportes2['id_transporte'].')" href="javascript:void(0)" class="trigger color" title="Read more">?</a></h3>
										<ul>
											<li>
												<span class="ico people"></span>
												<p>Max <strong>'.$transportes2['cantidad_max'].'</strong> <br />por vehiculo</p>
											</li>
											<li>
												<span class="ico luggage"></span>
												<p>Max <strong>'.$transportes2['cantidad_max'].'</strong> <br />por vehiculo</p>
									...
									<div class="one-fourth heightfix">
										<div>
											<div class="price">'.$transportes2['precio'].',00 <small>USD</small></div>
											<span class="meta">por vehiculo</span>
											<button type="submit" class="btn btn-primary large">seleccionar</button>
										</div>
									</div>
