  ...
  <body>
	...
	<main class="container-fluid">
		...
		<header class="site-title color" >
			<div class="wrap">
				<div class="container">
					<h1 class= "text-center">Destinos de Quintana Roo</h1>
				...
				<div class="three-fourth content">
					<div class="row">
						 ...
						 <div class="full-width">
							<article class="hentry">
								<div class="entry-featured">
									<img src="../images/hotel-airport-cancun.jpg" high="200" alt="taxi aeropuerto cancun a zona hotelera" />
									<div class="overlay">
										<a href="taxi-aeropuerto-cancun-a-zona-hotelera.php" class="expand">+</a>
									</div>
								</div>
								<div class="entry-content">
									<h2><a href="taxi-aeropuerto-cancun-a-zona-hotelera.php">Taxi Aeropuerto Cancun a Zona Hotelera</a></h2>
									<p>En la zona hotelera encontrarás diversidad de hermosas playas, el hermoso mirador que se encuentra en Playa Delfines, y si te gusta pasar una buena noche encontrarás varios lugares como Cocobongo, Hard Rock, La Vaquita etc.</p>
									<a href="taxi-aeropuerto-cancun-a-zona-hotelera.php" title="Read more" class="more">Leer Más</a>
								</div>
							</article>
						</div>
						<!-- //Post -->
						...
						<div class="full-width">
							<article class="hentry">
								<div class="entry-featured">
									<img src="../images/islamujeres.jpeg" alt="taxi aeropuerto cancun a isla mujeres" />
									<div class="overlay">
										<a href="taxi-aeropuerto-cancun-a-isla-mujeres.php" class="expand">+</a>
									</div>
								</div>
								<div class="entry-content">
									<h2><a href="taxi-aeropuerto-cancun-a-isla-mujeres.php"> Taxi Aeropuerto Cancun a isla mujeres</a></h2>
									<p>Te sugerimos visitar la hermosa Playa Norte con aguas cristalinas y hermosos colores azul turquesa y arena blanca, también cuenta con otros atractivos como tomar tours en catamarán, tours de snorkel. </p>
									<a href="taxi-aeropuerto-cancun-a-isla-mujeres.php" title="Read more" class="more">Leer más</a>
								</div>
							</article>
						</div>
						<!-- //Post -->
						...
						<div class="full-width">
							<article class="hentry">
								<div class="entry-featured">
									<img src="../images/tulumm.jpeg" alt="taxi aeropuerto cancun a tulum" />
									<div class="overlay">
										<a href="taxi-aeropuerto-cancun-a-tulum.php" class="expand">+</a>
									</div>
								</div>
								<div class="entry-content">
									<h2><a href="taxi-aeropuerto-cancun-a-tulum.php">Taxi Aeropuerto Cancun a Tulum</a></h2>
									<p>Es una ciudad en la costa de la Riviera Maya a hora y media del Aeropuerto de Cancún, si no cuenta con transporte para sus próximas vacaciones puede contactarnos somos Cancún Shuttke Airport contamos con traslados desde Aeropuerto-Hotel a la ciudad de Tulum o Hotel-Akumal o algún otro lugar que le gustaría conocer. </p>
									<a href="taxi-aeropuerto-cancun-a-tulum.php" title="Read more" class="more">Leer más</a>
								</div>
							</article>
						</div>
						<!-- //Post -->
						...
						<div class="full-width">
							<article class="hentry">
								<div class="entry-featured">
								<img src="../images/playa-del-carmen.jpeg" alt="taxi aeropuerto cancun a playa del carmen" />
									<div class="overlay">
										<a href="taxi-aeropuerto-cancun-a-playa-del-carmen.php" class="expand">+</a>
									</div>
								</div>
								<div class="entry-content">
									<h2><a href="taxi-aeropuerto-cancun-a-playa-del-carmen.php">Taxi Aeropuerto Cancun a Playa del Carmen</a></h2>
									<p>Es una hermosa ciudad costera que se encuentra a 55 km del Aeropuerto de Cancún, si no cuenta con transporte puede contactarnos somos Cancún Shuttle Airport tenemos traslados desde Aeropuerto-Hotel, o Hotel-Tulum, Hotel-Holbox, o algún otro destino que le gustaría visitar. </p>
									<a href="taxi-aeropuerto-cancun-a-playa-del-carmen.php" title="Read more" class="more">Leer más</a>
								</div>
							</article>
						</div>
						<!-- //Post -->
			...
			<div class="wrap">
				<div class="row">
					...
					<div class="one-third wow fadeIn">
						...
						<p>Reserve su servicio de transporte con nosotros.</p>
					</div>
					<!-- //Item -->
					...
					<div class="one-third wow fadeIn" data-wow-delay=".2s">
						...
						<p>Todos nuestros servicios son privados, viaje codomely con nosotros.</p>
					</div>
					<!-- //Item -->
					...
					<div class="one-third wow fadeIn" data-wow-delay=".4s">
						...
						<h4>Vehiculos de Calidad</h4>
						<p>Nuestros vehículos son inspeccionados para brindar un servicio seguro.</p>
					</div>
					<!-- //Item -->
				</div>
			</div>
