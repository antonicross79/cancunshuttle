...
$from_email_address = "CancunShuttleAirport<no-replyr@cancunshuttleairport.com>";
...
$respuesta6= mysqli_query($conexion,$sql);
    ...
    if($row['lang'] == "es"){
      ...
      $contenido_correo.='<img src="https://cancunshuttleairport.com/images/logocancuntransportation.jpeg" width="130" height="40" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
        ...
        <span style="float: right;">TOTAL + comision 9%: <b>'.$suma_total.' USD</b></span>
        </div>
        <table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
          <tbody>
            <tr>
        ...
        <table class="table" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 100%;">
          ...
          <tbody>';
            ...
            $contenido_correo.= '<tr>   
                                        ...
                                        <td></td>
                                        <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px;  border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0;" align="left" valign="top">'.$row2['suma'].',00 USD</td>
                                      </tr>';   
...
';
      ...
      $contenido_correo.='<img src="https://cancunshuttleairport.com/images/logocancuntransportation.jpeg" width="130" height="40" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
        ...
        <div class="">
        <span>Your confirmation code is: <b>CT0000000'.$id_reservacion.'</b></span>
        <span style="float: right;">TOTAL + commision 9%: <b>'.$suma_total.' USD</b></span>
        </div>
        <table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
          <tbody>
            <tr>
