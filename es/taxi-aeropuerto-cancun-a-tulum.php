  ...
  <body>
	...
	<main class="container-fluid">
		...
		<header class="site-title color" >
			<div class="wrap">
				<div class="container">
					<h1 class= "text-center">Taxi Aeropuerto  de Cancun a Tulum</h1>
...
<!-- //Intro -->
		...
		<div class="form-row p-5" style="border: 1px solid #00000059;border-radius: 20px;box-shadow: 5px 5px 10px 2px #00000042;background: white;">
			...
			<div class="input-group mb-3 col-xs-12 col-md-2">
			  <label for="transfer_type" class="col-xs-12 col-md-12 pb-0 pl-0">Tipo Traslado</label>
			...
			<div class="input-group mb-3 col-xs-3 col-md-1" id="arrival_time">
			  <label for="pickup_hour" class="col-xs-12 col-md-12 pb-0 pl-0">Fecha</label>
		 ...
		 <div class="container-fluid">
				  ...
				  <div class= "col-md-8 col-md-offset-3 mb-3 rounded"> 
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="../images/tulumm.jpeg" class="d-block w-100" alt="Taxi Aeropuerto  de Cancun a Tulum">
                        </div>
			...
			<div> <h2 class="text-center mt-5"> Taxi Aeropuerto  de Cancun a Tulum</h2> </div>
						        		             <p class="mt-3"><p>Es una ciudad en la costa de la Riviera Maya a hora y media del Aeropuerto de Cancún, si no cuenta con transporte para sus próximas vacaciones puede contactarnos somos Cancún Shuttle Airport contamos con traslados desde <a href="/es/taxi-aeropuerto-cancun-a-zona-hotelera.php">Aeropuerto-Hotel </a> a la ciudad de Tulum o Hotel-Akumall o algún otro lugar que le gustaría conocer.
						        		             En Tulum puedes encontrar hermosas playas y un atractivo que no te puedes perder son las ruinas mayas de Tulum que se encuentran a la orilla del mar de la ensenada de Tankah, también encuentran hermosos cenotes.</p>
